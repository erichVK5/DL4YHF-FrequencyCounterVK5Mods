...
; 2014-06    - Added support for 9.6, 13, 14.4, 19.6 MHZ xtal options     *
; 2014-01    - Added digit by digit testing for debugging display -VK5HSE *
;			   Added xtal options 4, 10, 12, 16 and 20MHz	  *
;			   Added display_variant_4 for common anode VK5HSE PCB v1.0	  *
...
#endif
#ifdef DISPLAY_VARIANT_4
  #define DISP_VARIANT 4   ; VK5HSE PCB design, seem to have accidentally swapped Digit 1/Digit 2 on v1.0 boards
  #define COMMON_ANODE   1
  #define COMMON_CATHODE 0
;  "Error, Must define DISPLAY_VARIANT_1, .._2, or .._3 or _4 under project options"
  ; With MPLAB: Project..Build Options..Project..MPASM..Macro Definitions..Add
#endif

; clock options added by VK5HSE
#ifdef CLOCK_VARIANT_4
  #define XTAL_VARIANT 4
#endif
#ifdef CLOCK_VARIANT_8
  #define XTAL_VARIANT 8
#endif
#ifdef CLOCK_VARIANT_96
  #define XTAL_VARIANT 96
#endif
#ifdef CLOCK_VARIANT_10
  #define XTAL_VARIANT 10
#endif
#ifdef CLOCK_VARIANT_12
  #define XTAL_VARIANT 12
#endif
#ifdef CLOCK_VARIANT_128
  #define XTAL_VARIANT 128
#endif
#ifdef CLOCK_VARIANT_13
  #define XTAL_VARIANT 13
#endif
#ifdef CLOCK_VARIANT_144
  #define XTAL_VARIANT 144
#endif
#ifdef CLOCK_VARIANT_16
  #define XTAL_VARIANT 16
#endif
#ifdef CLOCK_VARIANT_168
  #define XTAL_VARIANT 168
#endif
#ifdef CLOCK_VARIANT_1944
  #define XTAL_VARIANT 1944
#endif
#ifdef CLOCK_VARIANT_20
  #define XTAL_VARIANT 20
#endif
...
#if ((XTAL_VARIANT==4) || (XTAL_VARIANT==8) || (XTAL_VARIANT==96))  ; was display variant 1 : clocked with 4 MHz (low power, "XT" ) - VK5HSE - changed from display variant
   __CONFIG   _CP_OFF & _WDT_ON & _PWRTE_ON & _XT_OSC & _LVP_OFF & _BODEN_OFF & _MCLRE_OFF
#else                  ; xtal variants 10MHZ or above: clocked with >= 10 MHz (needs "HS" oscillator)
   __CONFIG   _CP_OFF & _WDT_ON & _PWRTE_ON & _HS_OSC & _LVP_OFF & _BODEN_OFF & _MCLRE_OFF
#endif

; consider option for external oscillator drive at 10MHz - VK5HSE
...
#if (XTAL_VARIANT==4)  ; xtal variant 4MHz : clocked with 4 MHz (low power consumption)
CLOCK     equ  .4000000
#endif
#if (XTAL_VARIANT==8)  ; xtal variant 8Mhz : clocked with 8 MHz
CLOCK     equ  .8000000
#endif
#if (XTAL_VARIANT==96)  ; xtal variant 9.6Mhz : clocked with 9.6 MHz
CLOCK     equ  .9600000
#endif
#if (XTAL_VARIANT==10)  ; xtal variant 10Mhz : clocked with 10 MHz for bitX
CLOCK     equ  .10000000
#endif
#if (XTAL_VARIANT==12)  ; xtal variant 12MHz  : clocked with 12 MHz for USB xtals
CLOCK     equ  .12000000
#endif
#if (XTAL_VARIANT==128)  ; xtal variant 12.8MHz : clocked with 12.8 MHz
CLOCK     equ  .12800000
#endif
#if (XTAL_VARIANT==13)  ; xtal variant 13Mhz : clocked with 13 MHz
CLOCK     equ  .13000000
#endif
#if (XTAL_VARIANT==144)  ; xtal variant 14.4Mhz : clocked with 14.4 MHz
CLOCK     equ  .14400000
#endif
#if (XTAL_VARIANT==16)  ; xtal variant 16MHz : clocked with 16 MHz
CLOCK     equ  .16000000
#endif
#if (XTAL_VARIANT==168)  ; xtal variant 16.8MHz : clocked with 16.8 MHz
CLOCK     equ  .16800000
#endif
#if (XTAL_VARIANT==1944)  ; xtal variant 19.44MHz : clocked with 19.44 MHz
CLOCK     equ  .19440000
#endif
#if (XTAL_VARIANT==20)  ; xtal variant 20MHz default : clocked with 20 MHz (higher resolution)
CLOCK     equ  .20000000
#endif

; microseconds per timing loop
#if (XTAL_VARIANT==4 || XTAL_VARIANT==1944)  ; display variant 1 : clocked with 4 MHz
...
#if (XTAL_VARIANT==8 || XTAL_VARIANT==96 || XTAL_VARIANT==168)  ; clocked with 8 or 9.6M or 16.8MHz
  ; Make sure all gate times can be divided by this interval without remainder :
  ; 1   second / 50 us = 20000  (ok)
  ; 1/4 second / 50 us =  5000  (ok)
  ; 1/8 second / 50 us =  2500  (ok)
...
#if (XTAL_VARIANT==10 || XTAL_VARIANT==12 || XTAL_VARIANT==128 || XTAL_VARIANT==13 || XTAL_VARIANT==144 ||  XTAL_VARIANT==16 || XTAL_VARIANT==20)  ; xtal variants 10, 12, 12.8, 13, 14.4, 16, 20 MHz
  ; 20 microseconds is impossible with 4-MHz-Crystal, so use 50 us instead ! 
  ; Make sure all gate times can be divided by this interval without remainder :
...
TIME      equ  .20
#endif ; slow xtal at 4MHz or > 10MHz xtal ?


; Clock cycles per timing loop.  See subroutine count_pulses .
;  Usually CYCLES=200 (for 4  MHz crystal,  50 usec - loop)
;			   or 200 (for 8  MHz crystal,  25 usec - loop)  
;			   or 200 (for 10 MHz crystal,  20 usec - loop)  
;			   or 300 (for 12 MHz crystal,  20 usec - loop)
;			   or 320 (for 16 MHz crystal,  20 usec - loop)
...
digit_8        equ  0x48      ; must contain a character (or trailing zero)
...
#if ((DISP_VARIANT==2) || (DISP_VARIANT==3) || (DISP_VARIANT==4))
...
#if (DISP_VARIANT==4)  ; muliplexer values for DISPLAY VARIANT #4 (5 digits, COMMON ANODE, VK5HSE PCB) :
                       ; Unused bits (b7..b4) are left HIGH as above .
          retlw b'11110100'        ; most significant digit is on   PA2 (!)   - VK5HSE PCB workaround
          retlw b'11111000'        ; next less significant dig. on  PA3 (!!)  - VK5HSE PCB workaround
          retlw b'11110001'        ; next less significant dig. on  PA0 (!!)
          retlw b'11110010'        ; 4th (sometimes the last) digit PA1 (!)
          retlw b'11110000'        ; 5th (OPTIONAL) least significant digit = NOT (PA3+PA2+PA1+PA0)
#endif   ; DISPLAY VARIANT #4
...
;    Variant 1.1:  With an 8-MHz-crystal, Timer0 can count up to 2 (not 5?!) MHz input,
;                MSB toggles every (128/2MHz) = 64 us, polled every 25us -> ok.
...
;    Variant 2.1:  With a 10-MHz-crystal, Timer0 can count up to 2.5 (not 5?!) MHz input,
;                MSB toggles every (128/2.5MHz) = 51 us, polled every 20us -> ok.
;    Variant 2.2:  With a 12-MHz-crystal, Timer0 can count up to 3 (not 5?!) MHz input,
;                MSB toggles every (128/3MHz) = 42 us, polled every 20us -> ok.
;    Variant 2.3:  With a 16-MHz-crystal, Timer0 can count up to 4 (not 5?!) MHz input,
;                MSB toggles every (128/4MHz) = 32 us, polled every 20us -> ok.
...
#if ((XTAL_VARIANT==4) || (XTAL_VARIANT==8) || (XTAL_VARIANT==10))  ; only 50 instruction cycles per loop in DISPLAY VARIANT 1 (f_xtal=4 MHz, t_loop=50us)
          ; Got some instruction cycles left ? Insert a few NOPs to bring to total loop time to 50us / 20us.
		  ; for a 10Mhz xtal/rubidium, and 20usec loop, that's 50 instructions as well, happy days, use same loop... VK5HSE
          nop                           ; [43]
;          nop                           ; [44] 
;          nop                           ; [45]  ugh, what a waste of precious CPU power ;-) - 66% less waste now! - VK5HSE

#if(COMMON_CATHODE)  ; display with COMMON CATHODE : 
          movlw 0x00                    ; segment drivers LOW to turn off [44]
#else  ; not COMMON CATHODE but COMMON ANODE:
          movlw 0xFF                    ; segment drivers HIGH to turn off [44]
#endif
          movwf LEDS_PORT               ; turn LED segments off [45]
; we just blanked the led driver lines on LED_PORT to avoid bleeding segments into optional 5th digit
		...
		; for 9.6MHz crystal, t_loop = 25usec, = 60 instructions  - VK5HSE
		; for 12MHz crystal, t_loop = 20usec, 0.33usec per instruction, = 60 instructions  - VK5HSE
		; for 12.8MHz crystal, t_loop = 20usec, = 64 instructions  - VK5HSE
		; for 13MHz crystal, t_loop = 20usec, = 65 instructions  - VK5HSE
		; for 14.4MHz crystal, t_loop = 20usec, 72 instructions  - VK5HSE

		; for 16MHz crystal, t_loop = 20uSec, 0.25usec per instruction, = 80 instructions  - VK5HSE
		; for 16.8MHz crystal, t_loop = 25usec, = 105 instructions  - VK5HSE
		; for 19.44MHz crystal, t_loop = 50usec, = 243 instructions  - VK5HSE

		; for 20MHz crystal, t_loop = 20uSec, 0.20usec per instruction, = 100 instructions - VK5HSE

#if (XTAL_VARIANT==96 || XTAL_VARIANT==12); For 9.6 or 12MHz clock - 60 instruction cycles per loop  - VK5HSE
          movlw .2     ; [43] load additional delay loops for total of 60 instructions (X=2, see below) into W
#endif
#if (XTAL_VARIANT==128); For 12.8MHz clock - 64 instruction cycles per loop  - VK5HSE
          movlw .3     ; [43] load additional delay loops for total of 64 instructions (X=3, see below) into W
#endif
#if (XTAL_VARIANT==13); For 13MHz clock - 65 instruction cycles per loop  - VK5HSE
          nop          ; [43]
          movlw .3     ; [44] load additional delay loops for total of 65 instructions (X=3, see below) into W
#endif
#if (XTAL_VARIANT==144); For 14.4MHz clock - 72 instruction cycles per loop  - VK5HSE
          movlw .5     ; [43] load additional delay loops for total of 72 instructions (X=5, see below) into W
#endif
#if (XTAL_VARIANT==16); For 16MHz clock - 80 instruction cycles per loop  - VK5HSE
          movlw .7     ; [43] load additional delay loops for total of 80 instructions (X=7, see below) into W
#endif
#if (XTAL_VARIANT==168); For 16.8MHz clock - 105 instruction cycles per loop  - VK5HSE
          nop           ; [43]
          movlw .13     ; [44] load additional delay loops for total of 105 instructions (X=3, see below) into W
#endif
#if (XTAL_VARIANT==1944); For 19.44MHz clock - 243 instruction cycles per loop  - VK5HSE
          nop           ; [43]
          nop           ; [44]
          nop           ; [45]
          movlw .47     ; [46] load additional delay loops for total of 243 instructions (X=3, see below) into W
#endif
#if (XTAL_VARIANT==20); For 20Mhz clock - 100 instruction cycles per loop  - VK5HSE
          movlw .12    ; [43] load additional delay loops for total of 100 instructions (X=12, see below) into W
#endif

#if ((XTAL_VARIANT==96) || (XTAL_VARIANT==12) || (XTAL_VARIANT==128) || (XTAL_VARIANT==13) || (XTAL_VARIANT==144) || (XTAL_VARIANT==16) || (XTAL_VARIANT==168) || (XTAL_VARIANT==1944) || (XTAL_VARIANT==20))

; in the case of clocks 12MHz, 16MHz, or 20MHz 
; a total of 60 or 80 or 100 instructions needed by the end of the cycle, respectively
; and we waste enough time to do this with the following loop
...
#if(COMMON_CATHODE)  ; display with COMMON CATHODE : 
          movlw 0x00                    ; segment drivers LOW to turn off [94]
#else  ; not COMMON CATHODE but COMMON ANODE:
          movlw 0xFF                    ; segment drivers HIGH to turn off [94]
#endif
          movwf LEDS_PORT               ; turn LED segments off [95]
; we just blanked the led driver lines on LED_PORT to avoid bleeding segments into optional 5th digit
...
;          nop                           ; [95]
          ...
          skpz                          ; [98]
          goto count1                   ; [99,100] = 20MHz or [79,80] = 16MHz or [59,60] = 12MHz - VK5HSE
                                        ; goto always takes TWO instruction cycles
...
#ENDIF  ; Test !
...
#if(DEBUG==0); some additional digit testing - VK5HSE
          ...
          movlw TEST                    ; test fifth LED display
          call  conv_char4
...
#endif ; not DEBUG - end of debugging char testing - VK5HSE
...
RANGE_DET_LOOPS equ  CLOCK/(.30*CYCLES) ; number of gate-time loops to detect the MEASURING RANGE
...
#if ((XTAL_VARIANT==8) || (XTAL_VARIANT==96) || (XTAL_VARIANT==10) || (XTAL_VARIANT==12) || (XTAL_VARIANT==12.8) || (XTAL_VARIANT==13) || (XTAL_VARIANT==144))
           ; Ranges FOR 8, 10, 12 MHz CRYSTAL
           ; Rng  testcount    f_in            prescaler gate_time   display,   resolution
           ; (1)     0..6         0.. 11.5 kHz   1       1   second  X.XXXkHz,  0.001kHz (4 digits only)
           ; (2)     7..54         ..103.6 kHz   1       1/2 second  XX.XXXkHz, 0.002kHz (last digit steps by 2) 
           ; (3)    55..511        ..981.1 kHz   1       1/4 second  XXX.XXkHz, 0.004kHz (last digit steps by 1)
           ; (3)   512..1023       ..  1.9 MHz   2       1/4 second  XXX.XXkHz, 0.008kHz (last digit steps by 1)
           ; (4)  1024..2047       ..  3.9 MHz   4       1/4 second  X.XXXXMHz, 0.016kHz (last digit steps by 1)
           ; (5)  2048..4095       ..  7.9 MHz   8       1/4 second  X.XXXXMHz, 0.032kHz (last digit steps by 1)
           ; (6)  4096..8191      ... 15.7 MHz  16       1/4 second  X.XXXXMHz, 0.064kHz (last digit steps by 1)
           ; (7)  8192..16383     ... 31.4 MHz  32       1/4 second  X.XXXXMHz, 0.128kHz (last digit steps by 1 or 2)
           ; (8) 16384..33300     ... 63.9 MHz  64       1/4 second  XX.XXXMHz, 0.256kHz (last digit steps by 1)

          movfw freq_ml        ; first look at bits 15..8 of the 'test count' result
          andlw b'11000000'    ; any of bits 15..14 set (>=16384) -> no Z flag -> range 9
          btfss STATUS,Z       ; skip next instruction if ZERO-flag set (!)
          goto  Range8         ; far jump to range 8
          btfsc freq_ml,5      ; bit 13 set (>=8192) ->  range 7
          goto  Range7
          btfsc freq_ml,4      ; bit 12 set (>=4096) ->  range 6
          goto  Range6
          btfsc freq_ml,3      ; bit 11 set (>=2048) ->  range 5
          goto  Range5         
          btfsc freq_ml,2      ; bit 10 set (>=1024) ->  range 4 
          goto  Range4         
          ...
          goto  Range2         ; freq > 10kHz -> range 2
          goto  Range1         ; otherwise range 1
#endif ; end of specific range-switching for  XTAL_VARIANT_10


#if ((XTAL_VARIANT==16) || (XTAL_VARIANT==168) || (XTAL_VARIANT==1944) || (XTAL_VARIANT==20))
           ; Ranges FOR xtal VARIANTs >= 10MHz (draws more power, but gives better resolution at HF )
           ; Even if PIC clocked with 20MHz, keep the input of TIMER0 below 4(!) MHz .

		   ; should "just work" with 10MHz, 12MHz 16MHz, options, given that gate time is also 20us - VK5HSE
		   ; and prescaler is asynchronous... I think....
...
#if ((XTAL_VARIANT==8) || (XTAL_VARIANT==9.6) || (XTAL_VARIANT==10) || (XTAL_VARIANT==12) || (XTAL_VARIANT==12.8) || (XTAL_VARIANT==13) || (XTAL_VARIANT==144))   ; Ranges 8 + 9  are only needed for VARIANT 1  with 4-MHz crystal :
...
#if (XTAL_VARIANT==4)   ; Ranges 8 + 9  are only needed for VARIANT 1  with 4-MHz crystal :
Range8:   ; Range 8: prescaler divide by 32 , gate time = default (1/4 sec) :
          movlw PSC_DIV_BY_32           ; let the prescaler divide by 2 while MEASURING...
          call  SetPrescaler            ; safely write <W> into option register
          movlw 7   ; multiply by 128 (=2^7) later to compensate prescaling (1:32) * gate time (1/4 s)
